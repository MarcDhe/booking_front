...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Header,  CoreModule, TranslateModule, LanguageSwitcherComponent], // Call TranslateModule to be available to use "translate" in the template
  template: `
  <div>
    <app-header />
    <main>
